...
<label>Website</label>
 <input type="url" name="website" placeholder="e.g. http://www.Localportal.com" autocomplete="off" value="<?php echo htmlentities($result->CompanyUrl)?>" >
</div>
...
<label>Industry</label>
 <input type="text" name="industry" placeholder="e.g. Insurance, hospital, Automobile" autocomplete="off" value="<?php echo htmlentities($result->industry)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Location</label>
 <input type="text" name="location" placeholder="e.g. Ratnanagar, Chitwan, Nepal" autocomplete="off" value="<?php echo htmlentities($result->lcation)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Established In</label>
 <input type="text" name="estin" placeholder="e.g. 14 Sept 2018, Chitwan" autocomplete="off" value="<?php echo htmlentities($result->establishedIn)?>">
</div>
